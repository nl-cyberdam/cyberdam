...
function initializeMenu(menuId, actuatorId) {
    ...
    actuator.parentNode.style.listStyleImage= "url(themes/default/img/plus.png)";//.backgroundImage = "url(themes/default/img/plus.gif)";
    actuator.onclick = function() {
        var display = menu.style.display;
        this.parentNode.style.listStyleImage = //.backgroundImage =
            (display == "block") ? "url(themes/default/img/plus.png)" : "url(themes/default/img/minus.png)";
...
function openMenu(menuId) {
    ...
    if (menu != null) {
        var display = menu.style.display;
        menu.parentNode.style.listStyleImage = "url(themes/default/img/minus.png)";
        menu.style.display = (display == "block") ? "none" : "block";
    }
}
