...
<html>
    <head>
        ...
        <title><cyb:systemname/>: <spring:message code="error.file.not.found"/></title>
        
<link rel="stylesheet" href="themes/default/style.css" type="text/css" />
    </head>
    <body>
        <h1 id="pagetitle"><spring:message code="error.file.not.found"/></h1>
        <div class="top-nav"></div>
        <div class="content">
        <div id="pageintroduction"><h3><spring:message code="error.occurred"/></h3></div>
  		<div class="errorBox">Error #404: <spring:message code="error.file.not.found"/></div>
		<br/>
  		Suggestions:
  		<ul>
